...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//Because a closure has been created by putting nestedFunction inside of myFunction and designing nestedFunction to look outside itself for the 'internal' variable. The closure is the nested function AND its surrounding state - the lexical environment
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(data){
    const low = data.filter(function(item){
